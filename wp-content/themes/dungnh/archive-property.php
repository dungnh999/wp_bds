        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block-heading text-center">
                    ...
                    <h2 class="f50 color-main fw700 uppercase"><?php echo __('BUY AND SELL REAL ESTATE', 'dungnh');?></h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="more-des text-center">
                    <a href="javascript:voild(0);" class="cta-more"><?php echo __('Readmore All', 'dungnh'); ?></a>
                </div>
            </div>
        </div>
    </div>
