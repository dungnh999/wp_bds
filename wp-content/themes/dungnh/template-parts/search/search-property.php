            ...
            <form id="form-property" action="<?php echo $current_url; ?>" method="GET" enctype="multipart/form-data">
                <div class="inner-form-group-search">
                    ...
                    <div class="filter-input">
                        <div class="filter-input-label"><?php echo (!empty($_GET['loaibds'])) ?  get_term_by('id', $_GET['loaibds'], 'loai-bds')->name : __('Type Property', 'dungnh'); ?> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                        </svg></div>
                        <div class="filter-dropdown-content">
                            <div class="inner-filter-dropdown">
                        ...
                        <div class="filter-dropdown-content dropdown-content-area">
                            <div class="inner-filter-dropdown">
                                ...
                                <div class="panel-area">
                                        <span class="f16 fw700"><?php echo __('Area', 'dungnh');?></span>
