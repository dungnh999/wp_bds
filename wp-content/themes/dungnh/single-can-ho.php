...
<main role="main" id="main-sg-canho">
    ...
    <div class="container">
        ...
        <div class="row mb-50">
            ...
            <div class="col-md-5">
                <div class="inner-sidebar-ch pt-50">
                    <p class="f30 fw700"><?php echo __('Related Rent', 'dungnh');?></p>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h3 class="f30 fw700"><?php echo __('Rent with the same price range', 'dungnh');?></h3>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h3 class="f30 fw700"><?php echo __('Rent in the same area', 'dungnh'); ?></h3>
            </div>
        </div>
        <div class="row mb-50 related-ch-bottom">
