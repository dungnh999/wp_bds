                    ...
                    <form action="https://cityspace.vn/tim-kiem-can-ho/" method="GET">
                        <div class="inner-form">
                            <div class="form-input form-keywork">
                                <label for="keywork"><?php echo __('Rent', 'devkai'); ?></label>
                                <input type="text" name="keywork" value="" placeholder="<?php echo __('Find the address...', 'devkai'); ?>" />
                            </div>

                            <div class="form-input">
                                <label for="date-form"><?php echo __('Check-in date', 'devkai'); ?></label>
                                <input type="text" name="your-date-form" value="">
                            </div>

                            <div class="form-input">
                                <label for="date-to"><?php echo __('Check-out date', 'devkai'); ?></label>
                                <input type="text" name="your-date-to" value="">
                            </div>

                            <div class="form-input form-submit">
                                <button class="btn-submit-form"><?php echo __('Search', 'devkai'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="container"  data-aos="fade-up">
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="https://cityspace.vn/can-ho" class="cta-more uppercase"><?php echo __('Readmore', 'devkai'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="sec-home-bds pt-80 pb-80 " >
    ...
    <div class="container heading-blog mb-5"  data-aos="fade-up">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-between align-items-end">
                ...
                <div class="heading-cat-post">
                    <ul>
                        <li><a href="#"><?php echo __('ALL', 'devkai');?></a></li>
                        <?php 
                        if(!empty($terms)) {
                            foreach($terms as $term) {
                                echo '<li><a href="'.get_term_link( $term->term_id, $term->taxonomy ).'">'.$term->name.'</a></li>';
    ...
    <div class="container"  data-aos="fade-up">
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="https://cityspace.vn/property/" class="cta-more uppercase"><?php echo __('Readmore', 'devkai'); ?></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container heading-blog mb-4">
        <div class="row">
            <div class="col-md-12 col-md-12 d-flex align-items-end justify-content-between" data-aos="fade-up">
                <div class="block-heading">
                    <p class="f18 color-1 fw700 uppercase"><?php echo __('Newsletter update', 'devkai'); ?></p>
                    <h2 class="f50 color-main fw800"><?php echo __('News', 'devkai'); ?></h2>
                </div>
