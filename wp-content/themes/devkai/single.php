            ...
            <div class="col-md-9">
                <div class="inner-post-content">
                    ...
                    <div class="meta-single d-flex align-items-center justify-content-end">
                        <div class="share">
                            <?php echo __('Share', 'devkai');?><?php echo socialshare(); ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3 sidebar-post">
                <div class="inner-sidebar">
                    ...
                    <aside class="category mb-5">
                        <h3 class="f18 fw700 uppercase"><?php echo __('Category', 'devkai');?></h3>
                    ...
                    <aside>
                        <h3 class="f18 fw700 uppercase"><?php echo __('Related Post', 'devkai');?></h3>
