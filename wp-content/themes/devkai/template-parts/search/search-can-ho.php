    ...
    <div class="inner-search">
        <div class="sortby">
            <div class="label-sortby">
                ...
                </svg><?php echo (!empty($_GET['orderby'])) ? $labelSort[$_GET['orderby']] : __('Sort', 'devkai'); ?></span>
            ...
            <form id="form-property" action="<?php echo $current_url; ?>" method="GET">
                <div class="inner-form-group-search">
                    ...
                    <div class="filter-input filter-input-search">
                        <input type="text" name="keywork" value="<?php echo !empty($_GET['keywork']) ? $_GET['keywork'] : ''; ?>" placeholder="<?php echo __('Enter keywork, ...' ,'devkai'); ?>">
                    ...
                    <button type="submit" style="display:none;"><?php echo __('Submit', 'devkai'); ?></button>
