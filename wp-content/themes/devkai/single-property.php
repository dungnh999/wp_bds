    ...
    <div class="container">
        ...
        <div class="col-md-8">
            <ul class="nav-ch">
                ...
                <li><a href="#tab1"><?php echo __('Detail', 'devkai'); ?></a></li>
                ...
                <div class="inner-info-ch">
                    ...
                    <div class="price-bds mb-3 d-flex align-items-center">
                        ...
                        if(!empty($price_dv_bds)) {
                            ?>
                            <div class="price-dv">
                                <span><?php echo __('Land unit price', 'devkai'); ?></span>
                    ...
                    <div class="list-tienich-bds mb-3">
                        <ul>
                            ...
                            if(!empty($bedroom_bds)) {
                                ...
                                </svg></span><div class="detail-content"><span>'.__('Bedroom', 'devkai').'</span><span class="fw700">'.$bedroom_bds.' Phòng</span></div></li>';
                            }
                            if(!empty($bathroom_bds)) {
                                ...
                                </svg></span><div class="detail-content"><span>'.__('Bathroom', 'devkai').'</</span><span class="fw700">'.$bathroom_bds.' Phòng</span></div></li>';
                            }
                            ...
                            if(!empty($area_bds)) {
                                ...
                                </svg></span><div class="detail-content"><span >'.__('Area', 'devkai').'</</</span><span class="fw700">'.$area_bds.' m2</span></div></li>';
                            }
                            if(!empty($all_huong)) {
                                echo '<li><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">
                                ...
                                </svg></span><div class="detail-content"><span >'.__('Direction', 'devkai').'</</</span><span class="fw700">'.$all_huong.'</span></div></li>'; 
                            }
                            ?>
                        </ul>
                    </div>
                ...
                <div class="group-content-ch">
                    <div id="tab1" class="tab-gioi-thieu sec-tab">
                        ...
                        <a href="javascript:voild(0);" class="color-main cta-more-gt"><?php echo __('Readmore', 'devkai');?> <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="22" viewBox="0 0 21 22" width="21"><path d="m17.0625 8.375-6.5625 6.5625-6.5625-6.5625" stroke="#c3912c" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                    </div>

                    <div id="tab2" class="tab-tien-ich sec-tab" >
                        <h3><?php echo __('Detail property', 'devkai'); ?></h3>
                ...
                <div class="box-contact-bds">
                    <div class="inner-box-contact d-flex align-items-center ">
                        ...
                        <div class="content-box-contact">
                            <p class="f18 fw700 mb-0"><?php echo __('Contact', 'devkai'); ?></p>
                            <p><?php echo __('Free counseling', 'devkai'); ?></p>
                            <a href="#" class="uppercase cta-more"><?php echo __('Contact', 'devkai'); ?> </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h3 class="f30 fw700"><?php echo __('Related Property', 'devkai');?></h3>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h3 class="f30 fw700"><?php echo __('Real estate same price', 'devkai');?></h3>
            </div>
        </div>
        <div class="row mb-50 related-ch-bottom">
        <?php 
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h3 class="f30 fw700"><?php echo __('Real estate same location', 'devkai');?></h3>
            </div>
        </div>
