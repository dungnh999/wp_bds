...
function create_new_custom_post_type()
{
    $args = array(
        ...
        // array(
        //     "post_type" => 'property',
        //     "name" => __('Property', 'devkai'),
        //     "single" => __('Property', 'devkai'),
        //     "slug" => "property",
        //     "rewrite" => "mua-ban-bds",
        //     "supports" => array('title', 'editor', 'author', 'thumbnail', 'excerpt', 'revisions', 'comments'),
        //     "icon" => 'dashicons-star-filled',
...

{
    $args = array(
        ...
        //     "name" => __('Loại BĐS', 'devkai'),

        //     "single" => __('Loại BĐS', 'devkai'),
		...
		// array(
        //     "post_type" => array('property'),
        //     "name" => __('Hướng', 'devkai'),
        //     "single" => __('Hướng', 'devkai'),
        //     "slug" => "huong-nha",
        //     "rewrite" => "huong-nha",
        //     "taxonomy" => "huong-nha",
        // ),
        ...
        array(
            ...
            "name" => __('Dự án', 'devkai'),
            "single" => __('Dự án', 'devkai'),
            "slug" => "du-an",
            "rewrite" => "du-an",
            "taxonomy" => "du-an",
        ),
        ...
        array(
            "post_type" => array('can-ho'),
            "name" => __('Danh mục căn hộ', 'devkai'),
            "single" => __('Danh mục căn hộ', 'devkai'),
        ...
        array(
            "post_type" => array('can-ho'),
            "name" => __('Danh mục loại phòng', 'devkai'),
            "single" => __('Danh mục loại phòng', 'devkai'),
