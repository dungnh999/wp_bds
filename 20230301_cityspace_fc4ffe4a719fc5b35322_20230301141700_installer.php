...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = '20230301_cityspace_fc4ffe4a719fc5b35322_20230301141700_archive.zip';
        const ARCHIVE_SIZE           = '306243214';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = 'fc4ffe4-01141700';
        const SECONDARY_PACKAGE_HASH = 'b625de8-01141700';
